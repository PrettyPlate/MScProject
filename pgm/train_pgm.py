...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_name", help="Experiment name.", type=str, default="exp_pgm")
    parser.add_argument("--dataset", help="Dataset name.", type=str, default="morphomnist")
    parser.add_argument(
        "--data_dir", help="Data directory to load form.", type=str, default=r"D:\Research\IC\MSc Project\causal-gen-main\datasets\morphomnist"
    )
    parser.add_argument(
